...
void pointing_device_init_user(void) {
    set_auto_mouse_layer(L_POINTER); // only required if AUTO_MOUSE_DEFAULT_LAYER is not set to index of <mouse_layer>
...
_______,    _______,                  _______,            _______,            _______, /**/ S_D_MOD,          _______,            _______,            _______,            CPI_UP, \
_______,    QK_MOUSE_BUTTON_3,        QK_MOUSE_BUTTON_2,  QK_MOUSE_BUTTON_1,  _______, /**/ KC_SNIPING_RESET, QK_MOUSE_BUTTON_1,  QK_MOUSE_BUTTON_2,  QK_MOUSE_BUTTON_3,  CPI_RESET, \
_______,    _______,                  _______,            _______,            _______, /**/ S_D_RMOD,         _______,           _______,            _______,             CPI_DOWN, \
                                      _______,            DRAG_SCROLL,        _______, /**/ _______,          _______
